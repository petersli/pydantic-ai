...
class GoogleModel(Model):
    ...
    async def _generate_content(
        ...
        try:
            ...
            _raise_model_error(e, self._model_name)
...
def _raise_model_error(e: errors.APIError, model_name: GoogleModelName) -> Never:
    """Wrap a Google API error in the appropriate model error."""
